...
import 'package:lavender_ai_app/screens/irrigation_history_screen.dart'; // Add this import
  ...
  Widget build(BuildContext context) {
    final actions = [
      ...
      },
      {
        ...
        'onTap': () {
          // Navigate to Irrigation History Screen
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => IrrigationHistoryScreen()),
          );
        },
      },
      {
        ...
        'label': 'Water Now',
        'color': const Color.fromARGB(255, 52, 69, 183),
        'onTap': () {
          // Navigate to irrigation dashboard using named route
