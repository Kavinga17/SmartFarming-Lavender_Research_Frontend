...
class _LightingControlScreenState extends State<LightingControlScreen> {
  ...
  Future<void> _fetchSensorData() async {
    final data = await LightingApiService.fetchSensorData();
    if (data != null) {
      setState(() {
        _latestSensor = data;
      });
  ...
  Future<void> _updateLighting() async {
    await LightingApiService.updateLighting(_lightingState);
  }

  Future<void> _updatePhotoperiod() async {
    await LightingApiService.updatePhotoperiod(_photoperiodEnabled, _lightOn, _lightOff);
  }
